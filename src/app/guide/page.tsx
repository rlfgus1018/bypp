...
// Static page: no database, nothing sent anywhere. The app chrome (header, banner) is left out by AppFrame.
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      <header className="sticky top-0 z-20 border-b border-slate-200 bg-white/95 backdrop-blur">
        <div className="mx-auto flex min-h-[62px] max-w-[1280px] flex-wrap items-center gap-x-6 gap-y-2 px-4 py-2 sm:px-10">
          <Link href="/guide" className="flex items-center gap-2.5">
          ...
          <Link href="/" className="rounded bg-slate-900 px-4 py-2 text-[13.5px] font-semibold text-white hover:bg-slate-700">
            업로드 시작하기
          </Link>
        </div>
      </header>
      ...
      <main>
        ...
        <section className="relative overflow-hidden bg-gradient-to-r from-navy-700 to-ark-500 px-4 py-10 sm:px-10">
          ...
          <div className="relative mx-auto flex max-w-[1200px] flex-wrap items-center gap-6">
            ...
            <div className="flex-1" />
            <Link href="/" className="rounded bg-slate-900 px-6 py-3.5 text-[15px] font-semibold text-white shadow-[0_3px_0_rgb(0_0_0/0.25)] hover:bg-slate-700">
              대화 파일 업로드
            </Link>
          </div>
        </section>
